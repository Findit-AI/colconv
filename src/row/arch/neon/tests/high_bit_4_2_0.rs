...
#[cfg(feature = "yuv-planar")]
fn check_p10_u8_equivalence(width: usize, matrix: KernelMatrix, full_range: bool) {
...
#[cfg(feature = "yuv-planar")]
fn check_p10_u16_equivalence(width: usize, matrix: KernelMatrix, full_range: bool) {
  let y = p10_plane(width, 37);
  let u = p10_plane(width / 2, 53);
  let v = p10_plane(width / 2, 71);
...
fn neon_p10_matches_scalar_odd_tail_widths() {
  for w in [18usize, 30, 34, 1922] {
    check_p10_u8_equivalence(w, KernelMatrix::Bt601, false);
    check_p10_u16_equivalence(w, KernelMatrix::Bt709, true);
  }
}
...
fn neon_p10_matches_scalar_1920() {
  check_p10_u8_equivalence(1920, KernelMatrix::Bt709, false);
  check_p10_u16_equivalence(1920, KernelMatrix::Bt2020Ncl, false);
}
...
#[cfg(feature = "yuv-planar")]
fn check_p_n_u8_equivalence<const BITS: u32>(width: usize, matrix: KernelMatrix, full_range: bool) {
...
fn neon_yuv420p9_matches_scalar_tail_and_large_widths() {
  ...
  for w in [18usize, 30, 34, 1922] {
    check_p_n_u8_equivalence::<9>(w, KernelMatrix::Bt601, false);
    check_p_n_u16_equivalence::<9>(w, KernelMatrix::Bt709, true);
  }
  check_p_n_u8_equivalence::<9>(1920, KernelMatrix::Bt709, false);
  check_p_n_u16_equivalence::<9>(1920, KernelMatrix::Bt2020Ncl, false);
}
...
#[cfg(feature = "yuv-semi-planar")]
fn check_p010_u8_equivalence(width: usize, matrix: KernelMatrix, full_range: bool) {
...
#[cfg(feature = "yuv-semi-planar")]
fn check_p010_u16_equivalence(width: usize, matrix: KernelMatrix, full_range: bool) {
  let y = p010_plane(width, 37);
  let u_plane = p010_plane(width / 2, 53);
  let v_plane = p010_plane(width / 2, 71);
  let uv = p010_uv_interleave(&u_plane, &v_plane);
...
fn neon_p010_matches_scalar_odd_tail_widths() {
  for w in [18usize, 30, 34, 1922] {
    check_p010_u8_equivalence(w, KernelMatrix::Bt601, false);
    check_p010_u16_equivalence(w, KernelMatrix::Bt709, true);
  }
}
...
fn neon_p010_matches_scalar_1920() {
  check_p010_u8_equivalence(1920, KernelMatrix::Bt709, false);
  check_p010_u16_equivalence(1920, KernelMatrix::Bt2020Ncl, false);
}
...
fn neon_p12_matches_scalar_tail_widths() {
  for w in [18usize, 30, 34, 1922] {
    #[cfg(feature = "yuv-planar")]
    check_planar_u8_neon_equivalence_n::<12>(w, KernelMatrix::Bt601, false);
    #[cfg(feature = "yuv-planar")]
    check_planar_u16_neon_equivalence_n::<12>(w, KernelMatrix::Bt709, true);
    #[cfg(feature = "yuv-semi-planar")]
    check_pn_u8_neon_equivalence_n::<12>(w, KernelMatrix::Bt601, false);
    #[cfg(feature = "yuv-semi-planar")]
    check_pn_u16_neon_equivalence_n::<12>(w, KernelMatrix::Bt2020Ncl, false);
  }
}
...
fn neon_p14_matches_scalar_tail_widths() {
  for w in [18usize, 30, 34, 1922] {
    check_planar_u8_neon_equivalence_n::<14>(w, KernelMatrix::Bt601, false);
    check_planar_u16_neon_equivalence_n::<14>(w, KernelMatrix::Bt709, true);
  }
}
...
fn neon_yuv420p_n_rgba_matches_scalar_tail_and_1920() {
  for w in [18usize, 30, 34, 1920, 1922] {
    check_planar_u8_neon_rgba_equivalence_n::<9>(w, KernelMatrix::Bt601, false);
    check_planar_u8_neon_rgba_equivalence_n::<10>(w, KernelMatrix::Bt709, true);
    check_planar_u8_neon_rgba_equivalence_n::<12>(w, KernelMatrix::Bt2020Ncl, false);
    check_planar_u8_neon_rgba_equivalence_n::<14>(w, KernelMatrix::YCgCo, true);
  }
}
...
fn neon_pn_rgba_matches_scalar_tail_and_1920() {
  for w in [18usize, 30, 34, 1920, 1922] {
    check_pn_u8_neon_rgba_equivalence_n::<10>(w, KernelMatrix::Bt601, false);
    check_pn_u8_neon_rgba_equivalence_n::<12>(w, KernelMatrix::Bt709, true);
  }
}

#[cfg(feature = "yuv-planar")]
fn check_yuv420p16_u8_neon_rgba_equivalence(width: usize, matrix: KernelMatrix, full_range: bool) {
...
#[cfg(feature = "yuv-semi-planar")]
fn check_p016_u8_neon_rgba_equivalence(width: usize, matrix: KernelMatrix, full_range: bool) {
  let y = p16_plane_neon(width, 37);
  let u = p16_plane_neon(width / 2, 53);
  let v = p16_plane_neon(width / 2, 71);
  let uv = p010_uv_interleave(&u, &v);
...
fn neon_yuv420p16_rgba_matches_scalar_all_matrices() {
  ...
  for w in [18usize, 30, 34, 1920, 1922] {
    check_yuv420p16_u8_neon_rgba_equivalence(w, KernelMatrix::Bt709, false);
  }
}
...
fn neon_p016_rgba_matches_scalar_all_matrices() {
  ...
  for w in [18usize, 30, 34, 1920, 1922] {
    check_p016_u8_neon_rgba_equivalence(w, KernelMatrix::Bt709, false);
  }
}
