...
fn avx2_matches_scalar_width_64() {
  ...
  check_equivalence(64, KernelMatrix::Bt601, true);
  check_equivalence(64, KernelMatrix::Bt709, false);
  check_equivalence(64, KernelMatrix::YCgCo, true);
}
...
fn avx2_rgba_matches_scalar_width_64() {
  ...
  check_rgba_equivalence(64, KernelMatrix::Bt601, true);
  check_rgba_equivalence(64, KernelMatrix::Bt709, false);
  check_rgba_equivalence(64, KernelMatrix::YCgCo, true);
}
...
fn avx2_yuva444p_rgba_matches_scalar_widths_and_alpha() {
  ...
  for seed in [13usize, 41, 127, 211] {
    check_yuv_444_rgba_with_alpha_src_equivalence(32, KernelMatrix::Bt601, false, seed);
  }
}
