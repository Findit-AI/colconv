...
fn avx512_x2rgb10_to_rgb_matches_scalar() {
  ...
  for w in [1usize, 31, 63, 64, 65, 127, 128, 129, 1920, 1921] {
    ...
    assert_eq!(out_scalar, out_avx, "AVX-512 x2rgb10_to_rgb diverges (width={w})");
  }
}
...
fn avx512_x2rgb10_to_rgba_matches_scalar() {
  ...
  for w in [1usize, 31, 63, 64, 65, 127, 128, 129, 1920, 1921] {
    ...
    assert_eq!(out_scalar, out_avx, "AVX-512 x2rgb10_to_rgba diverges (width={w})");
  }
}
...
fn avx512_x2rgb10_to_rgb_u16_matches_scalar() {
  ...
  for w in [1usize, 7, 8, 9, 31, 32, 33, 63, 64, 65, 1920, 1921] {
    ...
    assert_eq!(out_scalar, out_avx, "AVX-512 x2rgb10_to_rgb_u16 diverges (width={w})");
  }
}
...
fn avx512_x2bgr10_to_rgb_matches_scalar() {
  ...
  for w in [1usize, 31, 63, 64, 65, 127, 128, 129, 1920, 1921] {
    ...
    assert_eq!(out_scalar, out_avx, "AVX-512 x2bgr10_to_rgb diverges (width={w})");
  }
}
...
fn avx512_x2bgr10_to_rgba_matches_scalar() {
  ...
  for w in [1usize, 31, 63, 64, 65, 127, 128, 129, 1920, 1921] {
    ...
    assert_eq!(out_scalar, out_avx, "AVX-512 x2bgr10_to_rgba diverges (width={w})");
  }
}
...
fn avx512_x2bgr10_to_rgb_u16_matches_scalar() {
  ...
  for w in [1usize, 7, 8, 9, 31, 32, 33, 63, 64, 65, 1920, 1921] {
    ...
    assert_eq!(out_scalar, out_avx, "AVX-512 x2bgr10_to_rgb_u16 diverges (width={w})");
  }
}
