    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_rgb_or_rgba_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::y216_to_rgb_or_rgba_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_rgb_or_rgba_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::y216_to_rgb_or_rgba_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_rgb_or_rgba_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::y216_to_rgb_or_rgba_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_rgb_or_rgba_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::y216_to_rgb_or_rgba_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_rgb_or_rgba_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::y216_to_rgb_or_rgba_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_rgb_or_rgba_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::y216_to_rgb_or_rgba_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_rgb_or_rgba_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::y216_to_rgb_or_rgba_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_rgb_or_rgba_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::y216_to_rgb_or_rgba_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_rgb_or_rgba_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::y216_to_rgb_or_rgba_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_rgb_or_rgba_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::y216_to_rgb_or_rgba_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_rgb_u16_or_rgba_u16_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::y216_to_rgb_u16_or_rgba_u16_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_rgb_u16_or_rgba_u16_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::y216_to_rgb_u16_or_rgba_u16_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_rgb_u16_or_rgba_u16_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::y216_to_rgb_u16_or_rgba_u16_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_rgb_u16_or_rgba_u16_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::y216_to_rgb_u16_or_rgba_u16_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_rgb_u16_or_rgba_u16_row::<false, false>(
                packed, rgb_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::y216_to_rgb_u16_or_rgba_u16_row::<false, true>(
                packed, rgb_out, width, matrix, full_range,
              );
            }
          );
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_rgb_u16_or_rgba_u16_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::y216_to_rgb_u16_or_rgba_u16_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_rgb_u16_or_rgba_u16_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::y216_to_rgb_u16_or_rgba_u16_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_rgb_u16_or_rgba_u16_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::y216_to_rgb_u16_or_rgba_u16_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_rgb_u16_or_rgba_u16_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::y216_to_rgb_u16_or_rgba_u16_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_rgb_u16_or_rgba_u16_row::<true, false>(
                packed, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::y216_to_rgb_u16_or_rgba_u16_row::<true, true>(
                packed, rgba_out, width, matrix, full_range,
              );
            }
          );
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_luma_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::neon::y216_to_luma_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_luma_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::x86_avx512::y216_to_luma_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_luma_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::x86_avx2::y216_to_luma_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_luma_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::x86_sse41::y216_to_luma_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_luma_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::wasm_simd128::y216_to_luma_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_luma_u16_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::neon::y216_to_luma_u16_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_luma_u16_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::x86_avx512::y216_to_luma_u16_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_luma_u16_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::x86_avx2::y216_to_luma_u16_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_luma_u16_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::x86_sse41::y216_to_luma_u16_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_luma_u16_row::<false>(packed, luma_out, width);
            },
            unsafe {
              arch::wasm_simd128::y216_to_luma_u16_row::<true>(packed, luma_out, width);
            }
          );
          return;
        }
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::y216_to_hsv_row::<false>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::y216_to_hsv_row::<true>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::y216_to_hsv_row::<false>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::y216_to_hsv_row::<true>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::y216_to_hsv_row::<false>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::y216_to_hsv_row::<true>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::y216_to_hsv_row::<false>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::y216_to_hsv_row::<true>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::y216_to_hsv_row::<false>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::y216_to_hsv_row::<true>(
                packed, h_out, s_out, v_out, width, matrix, full_range,
              );
            }
          );
