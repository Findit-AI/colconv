    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::yuv_444p_n_to_rgba_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::yuv_444p_n_to_rgba_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::yuv_444p_n_to_rgba_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::yuv_444p_n_to_rgba_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::yuv_444p_n_to_rgba_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::yuv_444p_n_to_rgba_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::yuv_444p_n_to_rgba_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::yuv_444p_n_to_rgba_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::yuv_444p_n_to_rgba_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::yuv_444p_n_to_rgba_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
    ...
    cfg_select! {
      target_arch = "aarch64" => {
        if neon_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::neon::yuv_444p_n_to_rgba_u16_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::neon::yuv_444p_n_to_rgba_u16_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx512::yuv_444p_n_to_rgba_u16_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx512::yuv_444p_n_to_rgba_u16_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if avx2_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_avx2::yuv_444p_n_to_rgba_u16_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_avx2::yuv_444p_n_to_rgba_u16_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
        ...
        if sse41_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::x86_sse41::yuv_444p_n_to_rgba_u16_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::x86_sse41::yuv_444p_n_to_rgba_u16_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
      ...
      target_arch = "wasm32" => {
        if simd128_available() {
          ...
          dispatch_be!(
            unsafe {
              arch::wasm_simd128::yuv_444p_n_to_rgba_u16_row::<9, false>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            },
            unsafe {
              arch::wasm_simd128::yuv_444p_n_to_rgba_u16_row::<9, true>(
                y, u, v, rgba_out, width, matrix, full_range,
              );
            }
          );
