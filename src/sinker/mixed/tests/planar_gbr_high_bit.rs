  ...
  ($name:ident, $marker:ident, $walker:ident, $bits:literal) => {
    ...
    fn $name() {
      ...
      let mut sink = MixedSinker::<crate::source::$marker>::new(w, h)
        ...
        .unwrap();
      crate::source::$walker(&src, true, sink.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
  ...
  ($name:ident, $marker:ident, $walker:ident, $bits:literal, $w:literal) => {
    ...
    fn $name() {
      ...
      let mut sink_ref = MixedSinker::<crate::source::$marker>::new(w, h)
        ...
        .unwrap();
      crate::source::$walker(&src_ref, false, sink_ref.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
      ...
      let mut sink_combo = MixedSinker::<crate::source::$marker>::new(w, h)
        ...
        .unwrap();
      crate::source::$walker(&src_combo, false, sink_combo.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
  ...
  ($name:ident, $marker:ident, $walker:ident, $bits:literal, $w:literal) => {
    ...
    fn $name() {
...

      {
        ...
        crate::source::$walker(&src_simd, true, sink.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
      }
      {
        let mut sink = MixedSinker::<crate::source::$marker>::new(w, h)
          .with_rgb(&mut rgb_scal).unwrap()
          .with_rgba(&mut rgba_scal).unwrap();
        crate::source::$walker(&src_scal, false, sink.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
      }
    ...
    fn $name() {
      ...
      for use_simd in [false, true] {
        ...
        let mut sink_le = MixedSinker::<$marker>::new(w, h)
          ...
          .unwrap();
        $walker(&frame_le, true, sink_le.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
        ...
        $walker_endian(&frame_be, true, sink_be.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
