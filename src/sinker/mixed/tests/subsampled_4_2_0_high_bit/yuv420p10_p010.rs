...
fn yuv420p10_rgb_u8_only_gray_is_gray() {
  ...
  let mut sink = MixedSinker::<Yuv420p10>::new(16, 8)
    .with_rgb(&mut rgb)
    .unwrap();
  yuv420p10_to(&src, true, sink.set_kernel_matrix(KernelMatrix::Bt601)).unwrap();
...
fn yuv420p10_with_simd_false_matches_with_simd_true() {
  ...
  let mut s_scalar = MixedSinker::<Yuv420p10>::new(64, 16)
    ...
    .unwrap();
  yuv420p10_to(&src, false, s_scalar.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
  ...
  let mut s_simd = MixedSinker::<Yuv420p10>::new(64, 16)
    ...
    .unwrap();
  yuv420p10_to(&src, false, s_simd.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
...
fn yuv420p10_with_rgb_and_with_rgba_produce_byte_identical_rgb_bytes() {
  ...
  let mut s_solo = MixedSinker::<Yuv420p10>::new(64, 16)
    ...
    .unwrap();
  yuv420p10_to(&src, true, s_solo.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
...
fn p010_matches_yuv420p10_mixed_sinker_with_shifted_samples() {
  ...
  let mut s_p010 = MixedSinker::<P010>::new(w as usize, h as usize)
    ...
    .unwrap();
  yuv420p10_to(&src_p10, true, s_yuv.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
  p010_to(
    &src_p010,
    true,
    s_p010.set_kernel_matrix(KernelMatrix::Bt709),
  )
  .unwrap();
...
fn p010_with_simd_false_matches_with_simd_true() {
  ...
  let mut s_scalar = MixedSinker::<P010>::new(64, 16)
    ...
    .with_rgb_u16(&mut rgb_u16_scalar)
    .unwrap();
  p010_to(&src, false, s_scalar.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
  ...
  let mut s_simd = MixedSinker::<P010>::new(64, 16)
    ...
    .with_rgb_u16(&mut rgb_u16_simd)
    .unwrap();
  p010_to(&src, false, s_simd.set_kernel_matrix(KernelMatrix::Bt709)).unwrap();
...
fn yuv420p10_rgb_scratch_alloc_failure_leaves_outputs_untouched() {
  ...
  let err = yuv420p10_to(&src, false, sink.set_kernel_matrix(KernelMatrix::Bt601)).unwrap_err();
  drop(sink);
...
fn p010_rgb_scratch_alloc_failure_leaves_outputs_untouched() {
  ...
  super::super::super::arm_rgb_scratch_alloc_failure();
  let err = p010_to(&src, false, sink.set_kernel_matrix(KernelMatrix::Bt601)).unwrap_err();
  drop(sink);
