...
fn yuv420p12_rgb_u8_only_gray_is_gray() {
  ...
  let mut sink = MixedSinker::<Yuv420p12>::new(16, 8)
    .with_rgb(&mut rgb)
    .unwrap();
  yuv420p12_to(&src, true, KernelMatrix::Bt601, &mut sink).unwrap();
...
fn yuv420p12_with_simd_false_matches_with_simd_true() {
  ...
  let mut s_scalar = MixedSinker::<Yuv420p12>::new(64, 16)
    ...
    .unwrap();
  yuv420p12_to(&src, false, KernelMatrix::Bt709, &mut s_scalar).unwrap();
  ...
  let mut s_simd = MixedSinker::<Yuv420p12>::new(64, 16)
    ...
    .unwrap();
  yuv420p12_to(&src, false, KernelMatrix::Bt709, &mut s_simd).unwrap();
...
fn yuv420p14_rgb_u8_only_gray_is_gray() {
  ...
  let mut sink = MixedSinker::<Yuv420p14>::new(16, 8)
    .with_rgb(&mut rgb)
    .unwrap();
  yuv420p14_to(&src, true, KernelMatrix::Bt601, &mut sink).unwrap();
...
fn yuv420p14_with_simd_false_matches_with_simd_true() {
  ...
  let mut s_scalar = MixedSinker::<Yuv420p14>::new(64, 16)
    ...
    .with_rgb_u16(&mut rgb_u16_scalar)
    .unwrap();
  yuv420p14_to(&src, false, KernelMatrix::Bt709, &mut s_scalar).unwrap();
  ...
  let mut s_simd = MixedSinker::<Yuv420p14>::new(64, 16)
    ...
    .with_rgb_u16(&mut rgb_u16_simd)
    .unwrap();
  yuv420p14_to(&src, false, KernelMatrix::Bt709, &mut s_simd).unwrap();
...
fn p012_rgb_u8_only_gray_is_gray() {
  ...
  p012_to(&src, true, KernelMatrix::Bt601, &mut sink).unwrap();
...
fn p012_matches_yuv420p12_mixed_sinker_with_shifted_samples() {
  ...
  let mut s_p012 = MixedSinker::<P012>::new(w as usize, h as usize)
    ...
    .unwrap();
  yuv420p12_to(&src_p12, true, KernelMatrix::Bt709, &mut s_yuv).unwrap();
  p012_to(&src_p012, true, KernelMatrix::Bt709, &mut s_p012).unwrap();
...
fn p012_with_simd_false_matches_with_simd_true() {
  ...
  let mut s_scalar = MixedSinker::<P012>::new(64, 16)
    ...
    .with_rgb_u16(&mut rgb_u16_scalar)
    .unwrap();
  p012_to(&src, false, KernelMatrix::Bt709, &mut s_scalar).unwrap();
  ...
  let mut s_simd = MixedSinker::<P012>::new(64, 16)
    ...
    .with_rgb_u16(&mut rgb_u16_simd)
    .unwrap();
  p012_to(&src, false, KernelMatrix::Bt709, &mut s_simd).unwrap();
...
fn yuv420p12_rgb_scratch_alloc_failure_leaves_outputs_untouched() {
  ...
  let err = yuv420p12_to(&src, false, KernelMatrix::Bt601, &mut sink).unwrap_err();
  drop(sink);
...
fn yuv420p14_rgb_scratch_alloc_failure_leaves_outputs_untouched() {
  ...
  super::super::super::arm_rgb_scratch_alloc_failure();
  let err = yuv420p14_to(&src, false, KernelMatrix::Bt601, &mut sink).unwrap_err();
  drop(sink);
...
fn p012_rgb_scratch_alloc_failure_leaves_outputs_untouched() {
  ...
  super::super::super::arm_rgb_scratch_alloc_failure();
  let err = p012_to(&src, false, KernelMatrix::Bt601, &mut sink).unwrap_err();
  drop(sink);
